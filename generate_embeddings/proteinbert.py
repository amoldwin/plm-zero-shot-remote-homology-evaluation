...
def parse_args():
    ...
    parser.add_argument("--model_name", default="proteinbert", choices=["proteinbert"], help="An ProteinBERT model name")
...
# python -m generate_embeddings.proteinbert --data_name=SCOP