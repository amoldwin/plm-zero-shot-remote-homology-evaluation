...
mpirun -np ${SLURM_NTASKS} hhblits_mpi -i ~/PROJECTS/remote_homologs/data/SCOPe/hhblits/scope_th95.fas -d ~/PROJECTS/datasets/uniclust30/uniclust30_2018_08/uniclust30_2018_08 -oa3m scope_th95_n3_a3m_wo_ss -n 3 -cpu 1 -v 1 -maxmem 3
