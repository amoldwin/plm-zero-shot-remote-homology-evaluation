...
def compute_embeddings_similarities(sids: List, embeddings_dirpath: str, n_embeddings_to_load: int, is_random: bool = False):
    ...
    if is_random:
        reps = np.random.rand(n_embeddings_to_load, 64)
    else:
...
def parse_args():
    ...
    parser.add_argument("--model_name", default="esm1b_t33_650M_UR50S", choices=["random", "tapebert", "proteinbert", "esm1b_t33_650M_UR50S", "esm2_t33_650M_UR50D", "prottrans_bert_bfd", "prottrans_albert_bfd", "prottrans_t5_bfd"], help="A model name")
    parser.add_argument("--data_name", default="SCOPe", choices=["SCOPe", "SCOP"], help="A dataset name")
    parser.add_argument("--remote_homology_level", default="superfamily", choices=["superfamily", "fold"], help="Remote homology level")
...
if __name__ == "__main__":
    # parameters
    args = parse_args()
    data_name = args.data_name  # SCOP, SCOPe
    remote_homology_level = args.remote_homology_level  # superfamily, fold
    model_name = args.model_name # prottrans_t5_bfd
    print("Computing performance metrics for:", model_name, data_name, remote_homology_level)
...
# python analysis/compute_ranking_metrics.py
